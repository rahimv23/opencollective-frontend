  ...
  renderBankTransferInformation = () => {
    ...
    const amount = (
      <FormattedMoneyAmount
        amount={
          (get(this.props.data, 'order.amount.value') +
            get(this.props.data, 'order.platformContributionAmount.value', 0)) *
          100
        }
        currency={get(this.props.data, 'order.amount.currency')}
      />
    );
          ...
          <P fontSize="16px" color="black.700">
            <FormattedMessage
              ...
              values={{
                ...
                CollectiveLink: getI18nLink({ as: Link, collective: this.props.data.order.toAccount }),
              }}
            />
          </P>
        </Flex>
